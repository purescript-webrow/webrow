...
import WebRow.Routing (printRoute)
...
toHTTPResponse :: forall t7. Auth.Response -> Run t7 (HTTPResponse String)
toHTTPResponse = case _ of
  ...
  Auth.Responses.LogoutResponse →
    found $ printRoute (inj _auth Login)
